...
import Expect
import Sublist exposing (version, contains, sublist, ListComparison(..))
...
tests =
    describe "Sublist"
        ...
        , test "list1 contains list2" <|
            \() -> Expect.equal True (contains [1,2] [1])
        , test "list1 does not contain list2" <|
            \() -> Expect.equal False (contains [1,2] [3])
